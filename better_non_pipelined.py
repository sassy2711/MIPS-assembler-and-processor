...
#                         MEM_WB_rs_flag = 1
#                     elif(ID_EX["rt"] == MEM_WB["rd"]):
#                         MEM_WB_rt_flag = 1
#                 elif (EX_MEM["instruction type"] == "I"):
#                     if (opcode_dict_swapped[MEM_WB["opcode"]] == "lw"):
#                         lw_flag = 1
#                     if(ID_EX["rs"] == MEM_WB["rt"]):
#                         MEM_WB_rs_flag = 1
#             elif(i == 2):
#                 if (EX_MEM_rs_flag == 1 and lw_flag == 0):
#                     Register_File[ID_EX["rs"]] = EX_MEM["output"]
#                 elif (EX_MEM_rt_flag == 1 and lw_flag == 0):
#                     Register_File[ID_EX["rt"]] = EX_MEM["output"]
#                 EX_MEM = EX(ID_EX)
#             elif(i == 3):
#                 if (MEM_WB_rs_flag == 1 and lw_flag == 0):
#                     Register_File[ID_EX["rs"]] = EX_MEM["output"]
#                 elif (MEM_WB_rt_flag == 1 and lw_flag == 0):
#                     Register_File[ID_EX["rt"]] = EX_MEM["output"]
#                 MEM_WB = MEM(ID_EX)
#                 if (MEM_WB_rs_flag == 1 and lw_flag == 1):
#                     Register_File[ID_EX["rs"]] = EX_MEM["output"]
#                 elif (MEM_WB_rt_flag == 1 and lw_flag == 1):
#                     Register_File[ID_EX["rt"]] = EX_MEM["output"]
#                 if (MEM_WB_rs_flag == 1 and lw_flag == 1):
#                     Register_File[ID_EX["rs"]] = EX_MEM["output"]
#                 elif (MEM_WB_rt_flag == 1 and lw_flag == 1):
